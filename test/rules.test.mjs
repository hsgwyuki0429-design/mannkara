import { Board, createBlock } from '../src/core/board.js?v=202609230516';
import { resolveChains, resolveLine, nextActivation, decide } from '../src/core/mancala.js?v=202609230516';
import { Piece, PieceGenerator, SHAPES } from '../src/core/pieces.js?v=202609230516';
import { Game, isSolvable } from '../src/core/game.js?v=202609230516';
import { isInside, lineCells, SIZE } from '../src/core/constants.js?v=202609230516';
