import { SIZE, SCORE_PER_GOAL, chainMultiplier } from './constants.js?v=202609260952';
import { SHAPE_BY_NAME } from './pieces.js?v=202609260952';
import { solvable } from './planner.js?v=202609260952';
