import { SIZE, SCORE_PER_GOAL, chainMultiplier } from './constants.js?v=202609252223';
import { SHAPE_BY_NAME } from './pieces.js?v=202609252223';
import { solvable } from './planner.js?v=202609252223';
